...
// File from which this was generated: /home/Simon/nC_projects/Rat_Mitral_Cell_Gap_Network_copy4_copy2_Genesis_single_cell_no_calcium/cellMechanisms/NaxSH0_ChannelML/NaChannel.xml

// XSL file with mapping to simulator: /home/Simon/nC_projects/Rat_Mitral_Cell_Gap_Network_copy4_copy2_Genesis_single_cell_no_calcium/cellMechanisms/NaxSH0_ChannelML/ChannelML_v1.8.0_GENESIStab.xsl
...
function make_NaxSH0_ChannelML
        ...
        */
        ...
        str chanpath = "/library/NaxSH0_ChannelML"
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // A = 2.880000018, k = 0.1388888888, d = -30, in units: Physiological Units
            A = 2880.000018
            k = 138.8888888
            B = 1/k
            V0 = -0.03
            ...
            // A = 0.892800005, k = -0.1388888888, d = -30, in units: Physiological Units
            A = 892.800005
            k = -138.8888888
            B = 1/k
            V0 = -0.03
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // ChannelML form of equation: alpha = A*(k*(v-d))/(1 - exp(-(k*(v-d)))), with params:
            // A = 0.045, k = 0.6666666667, d = -45, in units: Physiological Units
            A = 45
            k = 666.6666667
            B = 1/k
            V0 = -0.045
            ...
            // ChannelML form of equation: beta = A*(k*(v-d))/(1 - exp(-(k*(v-d)))), with params:
            // A = 0.015, k = -0.6666666667, d = -45, in units: Physiological Units
            A = 15
            k = -666.6666667
            B = 1/k
            V0 = -0.045
            ...
            // A = 1, k = 0.25, d = -50, in units: Physiological Units
            A = 1
            k = 250
            B = 1/k
            V0 = -0.05
